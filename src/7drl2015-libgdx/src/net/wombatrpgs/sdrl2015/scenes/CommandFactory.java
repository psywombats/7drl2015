 ...
 */
package net.wombatrpgs.sdrl2015.scenes;

import net.wombatrpgs.sdrl2015.core.MGlobal;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandBlock;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandCameraPan;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandCameraSpeed;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandCameraTrack;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandGoToTitle;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandMove;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandPlayBGM;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandPlaySound;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandSetGraphic;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandSetLocation;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandSetSwitch;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandShowHide;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandSpeakAll;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandTeleport;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandTint;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandToggleHud;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandWait;
import net.wombatrpgs.sdrl2015.scenes.commands.CommandWaitAll;
